...
//  Phone Book
//
//  Created by عهد on 13/04/1443 AH.
//
...
class PhoneBookVC: UIViewController {
    ...
    var phonebooks: [CDPhoneBook]? = []
    let phonebook = CDPhoneBook()
    
    
    override func viewDidLoad() {
        super.viewDidLoad()
        setDelegate()
        phonebooks = PersistentStorage.shared.fetchManagedObject(managedObject: CDPhoneBook.self)
    }
